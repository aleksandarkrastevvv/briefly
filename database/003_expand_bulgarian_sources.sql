...
values
  ...
  ('BG', 'National Statistical Institute', 'https://www.nsi.bg', 'https://www.nsi.bg', 'official', 'Bulgarian', 'statistics', true, false, 'verified_page'),
  ...
  ('BG', 'Ministry of Electronic Governance', 'https://egov.bg', 'https://egov.bg/wps/portal/egov', 'official', 'Bulgarian', 'e_government', true, false, 'verified_page'),
  ...
  ('BG', 'Public Procurement Agency', 'https://www2.aop.bg', 'https://www2.aop.bg', 'official', 'Bulgarian', 'procurement', true, false, 'verified_page'),
  ...
  ('BG', 'Ombudsman of Bulgaria', 'https://www.ombudsman.bg', 'https://www.ombudsman.bg', 'official', 'Bulgarian', 'rights', true, false, 'verified_page'),
  ('BG', 'Road Infrastructure Agency', 'https://www.api.bg', 'https://www.api.bg', 'official', 'Bulgarian', 'transport', true, false, 'verified_page'),
...
from (
  values
    ...
    ('BG', 'Ministry of Finance', '{"allowedPathPrefixes":["/bg/news"],"includeKeywords":["news"],"maxLinks":15}'),
    ('BG', 'Ministry of Interior', '{"includeKeywords":["press","novini","news"],"maxLinks":15}'),
    ('BG', 'Ministry of Health', '{"allowedPathPrefixes":["/bg/novini"],"includeKeywords":["novini"],"maxLinks":15}'),
    ('BG', 'Ministry of Education and Science', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ('BG', 'National Revenue Agency', '{"includeKeywords":["actualno","news","novini"],"maxLinks":15}'),
    ('BG', 'National Statistical Institute', '{"includeKeywords":["news","press","novini"],"maxLinks":15}'),
    ('BG', 'Ministry of Electronic Governance', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ('BG', 'Registry Agency', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ('BG', 'Public Procurement Agency', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ...
    ('BG', 'Ombudsman of Bulgaria', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ('BG', 'Road Infrastructure Agency', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ('BG', 'Sofia Municipality', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
    ...
    ('BG', 'Sliven Municipality', '{"includeKeywords":["novini","news"],"maxLinks":15}'),
